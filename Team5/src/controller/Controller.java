...
public class Controller extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			nextPage = performAction(request);
		} catch (Exception e) {
	...
	private String performAction(HttpServletRequest request) {
		...
		// if (action.equals("login_employee.do") ||
		// action.equals("login_customer.do")) {
	...
	// void --> String
	private String sendToNextPage(String nextPage, HttpServletRequest request, HttpServletResponse response)
		...
		// }
		//
		// if (nextPage.startsWith("http") || nextPage.startsWith("ftp") ||
		// nextPage.startsWith("file")) {
		// response.sendRedirect(nextPage);
		// return;
		// }
		//
		...
		// ".sendToNextPage(\"" + nextPage + "\"): invalid url.");
